...
class PivotCCIStrategy:
    ...
    def __init__(self, data, tickers=None, **kwargs):
        ...
        logger.debug(f"Initialized PivotCCIStrategy with params: {self.params}")
        logger.info(
            f"PivotCCIStrategy initialized with cci_period={self.params['cci_period']}, "
